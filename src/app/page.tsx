    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="mb-16 flex items-center justify-between gap-10">
        <div className="space-y-4">
          ...
          <p className="text-xl text-gray-800">{config.site.description}</p>
        ...
        <img
          src={`${config.site.basePath}/images/avatar-eyes.png`}
          alt="WZH avatar"
          className="hidden h-44 w-44 shrink-0 rounded-full object-cover sm:block"
        />
      </div>
